...
URGENCY_PATTERNS = ['\\bact now\\b', '\\bact fast\\b', '\\bwithin 24 hours\\b', '\\burgent\\b', '\\bverify (?:your|now)\\b', '\\bsuspend(?:ed)?\\b', '\\bclick (?:here|below)\\b', '\\blimited time\\b', '\\bimmediately\\b', '\\bconfirm your (?:account|identity)\\b', '\\bfor the project\\b', '\\brefund\\b.{0,20}\\bprocess(?:ing)?\\b']
